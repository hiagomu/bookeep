/*
  ...
  - Added the required column `saleLink` to the `Post` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "saleLink" TEXT NOT NULL,
