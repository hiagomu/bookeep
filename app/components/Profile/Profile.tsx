...
export const Profile = ({ posts, user }: IProfile) => {
    ...
    return (
        <div className="w-[25rem] h-[26.5rem] bg-white dark:bg-secondaryDarkColor shadow-primary mt-28 mr-24 rounded-lg relative max-xl:w-[19rem] max-xl:h-[23rem] max-xl:mr-8 max-lg:mr-0 max-lg:mt-20 max-lg:w-post-lg max-md:w-post-md max-sm:w-post-sm max-sm:h-[18rem]">
            ...
            <div className="flex mt-6 w-[25.75rem] justify-evenly max-xl:w-[19rem] max-lg:w-post-lg max-lg:mt-4 max-sm:w-post-sm max-sm:mt-2">
